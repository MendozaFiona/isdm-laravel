...
<html lang="en">
  ...
  <body>
    ...
    <div class="homebody">
      <div class="row">
        <div class="col">
          <img src="{{ asset('images/dashb1.jpg') }}">
        ...
        <thead>
          <tbody>
            ...
            <tr>
              <th scope="row"></th>
              <td>
                <img class="news1"src="{{ asset('images/dash3.jpg') }}">
              </td>
              <td class="">
                ...
                Busa, uban sa 
                Department of Interior and Local Government(DILG)-Region X
                Bureau of Fire & Protection (BFP) - Nazareth Station
                ug pangagamhanang Local sa Nazareth pinanguluhan sa atong Kapitan Max "Jonjon" T. Rodriguez III, 
                Mipahinumdum nga walay nalipay sa Nasunugan!...</p>
                 <a href="https://www.facebook.com/teamrodriguez123/posts/1528570937296948" class="card-link">View More</a>
                </td>  
              <td></td>
            </tr>
            <tr>
